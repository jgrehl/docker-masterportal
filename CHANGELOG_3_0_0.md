...
- The parameter "style" was added to the GetGraphicLegend request for WMS layer.
- A layer name configured as array in config.json is now shown as string in the legend and in printing.
